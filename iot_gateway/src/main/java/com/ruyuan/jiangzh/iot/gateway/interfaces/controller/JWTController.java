...
public class JWTController {
    ...
    public RespDTO login(@RequestBody UserPwdDTO userPwdDTO){
        ...
        result.put(JWTUtils.getJwtHeaderName(), jwtStr);
    ...
    /*
        ...
        header:
            jwt :
            eyJhbGciOiJIUzUxMiJ9.eyJyYW5kb21LZXkiOiJ6eGhtcWUiLCJzdWIiOiJhbGxlbiIsImV4cCI6MTY1MDU1MDgyNywiaWF0IjoxNjQ5OTQ2MDI3fQ.Vxp9jFlZpmyRm6NajTgq9RSZcO6M6FsSbln2YtkK3EVpueR7Lq8BGWa9GmX92rmz99dXotnQI4n0exre1RaOpg
     */
    /*
        {
            "code": 200,
            "requestId": "1b8d8bba1f9248a3beaaccf5ad9dd2f3",
            "message": "",
            "state": "",
            "data": "allen"
        }
    ...
    public RespDTO test(HttpServletRequest request){
        String username = request.getAttribute(CommonEnums.USERNAME_HEADER.getName()) + "";
        logger.info("username : [{}]", username);
        return RespDTO.success(username);
    }
